...
public class User extends BaseModel {
	...
	/**
	 * 描述:userId 字段: user_id INT(10)
	 */
	private java.lang.Integer userId;
	/**
	 * 描述:groupId 字段: group_id INT(10)
	 */
	private java.lang.Integer groupId;
	/**
	 * 描述:用户名 字段: username VARCHAR(100)
	 */
	private java.lang.String username;
	/**
	 * 描述:邮箱 字段: email VARCHAR(100)
	 */
	private java.lang.String email;
	/**
	 * 描述:注册时间 字段: register_time DATETIME(19)
	 */
	...
	/**
	 * 描述:注册IP 字段: register_ip VARCHAR(50)
	 */
	private java.lang.String registerIp;
	/**
	 * 描述:最后登录时间 字段: last_login_time DATETIME(19)
	 */
	...
	/**
	 * 描述:最后登录IP 字段: last_login_ip VARCHAR(50)
	 */
	private java.lang.String lastLoginIp;
	/**
	 * 描述:登录次数 字段: login_count INT(10)
	 */
	private java.lang.Integer loginCount;
	/**
	 * 描述:管理员级别 字段: rank INT(10)
	 */
	private java.lang.Integer rank;
	/**
	 * 描述:上传总大小 字段: upload_total BIGINT(19)
	 */
	private java.lang.Long uploadTotal;
	/**
	 * 描述:上传大小 字段: upload_size INT(10)
	 */
	private java.lang.Integer uploadSize;
	/**
	 * 描述:上传日期 字段: upload_date DATE(10)
	 */
	...
	/**
	 * 描述:是否管理员 字段: is_admin BIT(0)
	 */
	private java.lang.Boolean isAdmin;
	/**
	 * 描述:是否只读管理员 字段: is_viewonly_admin BIT(0)
	 */
	private java.lang.Boolean isViewonlyAdmin;
	/**
	 * 描述:是否只管理自己的数据 字段: is_self_admin BIT(0)
	 */
	private java.lang.Boolean isSelfAdmin;
	/**
	 * 描述:是否禁用 字段: is_disabled BIT(0)
	 */
